...
export default function VaultHistory() {
  ...
  // const renderRow = useCallback((entry: {oToken: undefined | {id: string, symbol:string, decimals: number }, asset:{id: string, symbol:string, decimals: number}, amount:string}) => {
  ...
  //     : <CustomIdentityBadge entity={entry.asset.id} label={entry.asset.symbol} />
