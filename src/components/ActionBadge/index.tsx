...
export function DepositCollateralBadge() {
  return <Tag color="#004080" background="#b3d9ff" size="normal" > Deposit Collateral </Tag> 
}

export function WithdrawCollateralBadge() {
  return <Tag color="#004080" background="#b3d9ff" size="normal" > Withdraw Collateral </Tag> 
}

export function DepositLongBadge() {
  return <Tag color="#006600" background="#c2f0c2" size="normal"> Deposit Long </Tag> 
}

export function WithdrawLongBadge() {
  return <Tag color="#006600" background="#c2f0c2" size="normal" > Withdraw Long </Tag> 
}

export function MintShortBadge() {
  return <Tag color="#800000" background="#ffb3b3" size="normal"> Mint Short </Tag> 
}

export function BurnShortBadge() {
  return <Tag color="#800000" background="#ffb3b3" size="normal"> Burn Short </Tag> 
}
