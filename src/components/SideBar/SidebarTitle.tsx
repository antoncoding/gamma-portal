...
function SidebarTitle({ title, icon, onClick, isSelected }: { title: any, icon: any, isSelected: boolean, onClick: any }) {
      ...
      <div style={{ paddingLeft: '10%', paddingTop: '5%', borderLeft: '3px solid', borderColor: hintColor }} >
        <LinkBase onClick={onClick} style={{ width: '100%', paddingBottom: 10}} >
          <div style={{ display: 'flex' }}>
            ...
            <div style={{ verticalAlign: 'middle', paddingLeft: 5, color: theme.contentSecondary, fontSize: 18 }}>{title} </div>
          </div>
        </LinkBase>
      </div>
    </div>
